...
public class ForeProductDetailsController extends BaseController {
    ...
    @RequestMapping("/product/{pid}" )
     public String goToPage(HttpSession session, HttpServletRequest request, Map<String, Object> map,
        ...
        //nfo("分类ID为{}的产品总数为{}条", category_id, total);
        //生成随机数
        ...
        logger.info("单个商品:"+map.toString());
        request.setAttribute("danmap",map );
        //nfo("转到前台-产品详情页");
//        return "/page/person/two/home/introduction";
        return "/page/person/two/home/productDetailsPage";
    }
    ...
    public String guessYouLike(@PathVariable("cid") Integer cid, @RequestParam Integer guessNumber) {
        ...
        //nfo("guessNumber值为{}，新guessNumber值为{}", guessNumber, i);
