...
<head>
    ...
    <link href="res/css/amazeui.css" rel="stylesheet" type="text/css">

    <link href="res/css/personal.css" rel="stylesheet" type="text/css">
    <link href="res/css/blstyle.css" rel="stylesheet" type="text/css">
    <script src="res/js/jquery.min.js"></script>
    <script src="res/js/amazeui.js"></script>
</head>
<body>
<!--头 -->
<header>
        ...
        <div class="main-wrap">
            ...
            <div class="user-bill">
                ...
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf"><strong class="am-text-danger am-text-lg"><a th:href="zhangdan">账单</a></strong> / <small>Electronic&nbsp;bill</small></div>
                </div>
                <hr/>
                                    ...
                                    <li>
                                        <div  class="cards-carousel">
                                            <div class="mask">
                                                ...
                                                <div class="bank ng-binding" style="background-image: url(../../spring_person/src/main/resources/static/images/combo.png);">中国农业银行</div>
                                                <div class="details">
                                                    <a>查看详情</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="cards-details">
                                            <div class="bank-name">
                                                <div class="name fn-left" style="background-image: url(../../spring_person/src/main/resources/static/images/combo.png);"></div>
                                    ...
                                    <li>
                                        <div  class="cards-carousel">
                                            <div class="mask">
                                                ...
                                                <div class="bac fn-left"></div>
                                                <div class="bank ng-binding" style="background-image: url(../../spring_person/src/main/resources/static/images/combo1.png);">中国建设银行</div>
                                                <div class="details">
                                                    <a>查看详情</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="cards-details">
                                            <div class="bank-name">
                                                <div class="name fn-left" style="background-image: url(../../spring_person/src/main/resources/static/images/combo1.png);"></div>
                                                <span class="close fn-right"><a>X</a></span>
                                            </div>
                                            <div class="bank-detail">
                                                <div class="totalin fn-left">
                                    ...
                                    <li>
                                        <div  class="cards-carousel">
                                            <div class="mask">
                                                ...
                                                <div class="bac fn-left"></div>
                                                <div class="bank ng-binding" style="background-image: url(../../spring_person/src/main/resources/static/images/combo2.png);">浦发银行</div>
                                                <div class="details">
                                                    <a>查看详情</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="cards-details">
                                            <div class="bank-name">
                                                <div class="name fn-left" style="background-image: url(../../spring_person/src/main/resources/static/images/combo2.png);"></div>
                                                <span class="close fn-right"><a>X</a></span>
                                            </div>
                                            <div class="bank-detail">
                                                <div class="totalin fn-left">
                                    ...
                                    <li>
                                        <div  class="cards-carousel">
                                            <div class="mask">
                                                ...
                                                <div class="bac fn-left"></div>
                                                <div class="bank ng-binding" style="background-image: url(../../spring_person/src/main/resources/static/images/combo3.png);">中国光大银行</div>
                                                <div class="details">
                                                    <a>查看详情</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="cards-details">
                                            <div class="bank-name">
                                                <div class="name fn-left" style="background-image: url(../../spring_person/src/main/resources/static/images/combo3.png);"></div>
                                                <span class="close fn-right"><a>X</a></span>
                                            </div>
                                            <div class="bank-detail">
                                                <div class="totalin fn-left">
