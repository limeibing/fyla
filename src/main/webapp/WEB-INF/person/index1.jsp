...
<header>
    <article>
        <div class="mt-logo">
            ...
            <div class="nav white">
                <div class="logoBig">
                    <li><img src="../../spring_person/src/main/resources/static/images/logobig.png" /></li>
                </div>
            ...
            <div class="wrap-left">
                <div class="wrap-list">
                    <div class="m-user">
                        ...
                        <div class="m-userinfo">
                            ...
                            <div class="m-baseinfo">
                                <a class="m-pic" href="information.jsp">
                                    <img src="../../spring_person/src/main/resources/static/images/getAvatar.do.jpg">
                                </a>
                                <div class="m-info">
                                    <em class="s-name">小叮当</em>
                                    <div class="vip1"><a href="#"><span></span><em>会员专享</em></a></div>
                                    <div class="safeText"><a href="safety.jsp">账户安全:<em style="margin-left:20px ;">60</em>分</a>
                        ...
                        <div class="wallet">
                            ...
                            <p class="m-big squareS">
                                <a href="#">
                                    <i><img src="../../spring_person/src/main/resources/static/images/shopping.png"/></i>
                                    <span class="m-title">能购物</span>
                                </a>
                            </p>
                            <p class="m-big squareA">
                                <a href="#">
                                    <i><img src="../../spring_person/src/main/resources/static/images/safe.png"/></i>
                                    <span class="m-title">够安全</span>
                                </a>
                            </p>
                            <p class="m-big squareL">
                                <a href="#">
                                    <i><img src="../../spring_person/src/main/resources/static/images/profit.png"/></i>
                    ...
                    <div class="m-order">
                        ...
                        <ul>
                            <li><a href="order.jsp"><i><img src="../../spring_person/src/main/resources/static/images/pay.png"/></i><span>待付款</span></a></li>
                            <li><a href="order.jsp"><i><img src="../../spring_person/src/main/resources/static/images/send.png"/></i><span>待发货<em class="m-num">1</em></span></a></li>
                            <li><a href="order.jsp"><i><img src="../../spring_person/src/main/resources/static/images/receive.png"/></i><span>待收货</span></a></li>
                            <li><a href="order.jsp"><i><img src="../../spring_person/src/main/resources/static/images/comment.png"/></i><span>待评价<em class="m-num">3</em></span></a></li>
                            <li><a href="change.jsp"><i><img src="../../spring_person/src/main/resources/static/images/refund.png"/></i><span>退换货</span></a></li>
                        </ul>
                        <div class="orderContentBox">
                            <div class="orderContent">
                                <div class="orderContentpic">
                                    <div class="imgBox">
                                        <a href="orderinfo.jsp"><img src="../../spring_person/src/main/resources/static/images/youzi.jpg"></a>
                                    </div>
                                </div>
                        ...
                        <div class="orderContentBox">
                            <div class="orderContent">
                                <div class="orderContentpic">
                                    <div class="imgBox">
                                        <a href="orderinfo.jsp"><img src="../../spring_person/src/main/resources/static/images/heart.jpg"></a>
                                    </div>
                                </div>
                                <div class="detailContent">
                        ...
                        <div class="twoTabModel credit">
                            ...
                            <div class="Box">
                                ...
                                <div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:108, itemMargin:3, slideshow: false}">
                                    <ul class="am-slides">
                                        <li><a href="#"><img src="../../spring_person/src/main/resources/static/images/333.jpg" /></a></li>
                                        <li><a href="#"><img src="../../spring_person/src/main/resources/static/images/222.jpg" /></a></li>
                                        <li><a href="#"><img src="../../spring_person/src/main/resources/static/images/111.jpg" /></a></li>
                                        <li><a href="#"><img src="../../spring_person/src/main/resources/static/images/333.jpg" /></a></li>
                                        <li><a href="#"><img src="../../spring_person/src/main/resources/static/images/222.jpg" /></a></li>
                                        <li><a href="#"><img src="../../spring_person/src/main/resources/static/images/111.jpg" /></a></li>
                                    </ul>
                    ...
                    <div class="new-goods-info">
                        <a class="shop-info" href="#">
                            <div class="face-img-panel">
                                <img src="../../spring_person/src/main/resources/static/images/imgsearch1.jpg" alt="">
                            </div>
                ...
                <div class="new-goods">
                    ...
                    <div class="new-goods-info">
                        <a class="shop-info" href="#" target="_blank">
                            <div >
                                <img src="../../spring_person/src/main/resources/static/images/666.jpg" alt="">
                            </div>
                ...
                <div class="am-tabs-bd">
                    ...
                    <div data-tab-panel-0 class="am-tab-panel am-active">
                        <div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:155,slideshow: false}">
                            <ul class="am-slides">
                                <li>
                                    <a><img class="am-thumbnail" src="../../spring_person/src/main/resources/static/images/EZA27501.jpg" /></a>
                                    <strong class="price">¥32.9</strong>
                                </li>
                                <li>
                                    <a><img class="am-thumbnail" src="../../spring_person/src/main/resources/static/images/BxJk6.jpg" /></a>
                                    <strong class="price">¥32.9</strong>
                                </li>
                                <li>
                                    <a><img class="am-thumbnail" src="../../spring_person/src/main/resources/static/images/Hxcag60.jpg" /></a>
                                    <strong class="price">¥32.9</strong>
                                </li>
                                <li>
                                    <a><img class="am-thumbnail" src="../../spring_person/src/main/resources/static/images/youzi.jpg" /></a>
                                    <strong class="price">¥32.9</strong>
                                </li>
                                <li>
                                    <a><img class="am-thumbnail" src="../../spring_person/src/main/resources/static/images/EZA27501.jpg" /></a>
