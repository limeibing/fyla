...
<html>
	...
	<head>
		...
		<link href="res/css/refstyle.css" rel="stylesheet" type="text/css">

		<script src="res/js/jquery.min.js" type="text/javascript"></script>
		<script src="res/js/amazeui.js" type="text/javascript"></script>
						...
						<div class="refund-aside">
							<div class="item-pic">
								<a href="#" class="J_MakePoint">
									<img src="../../spring_person/src/main/resources/static/images/comment.jpg_400x400.jpg" class="itempic">
								</a>
							</div>
