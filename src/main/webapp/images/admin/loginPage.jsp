...
<div id="div_background">
    ...
    <div id="div_main">
        ...
        <div id="div_content">
            ...
            <form id="form_login" >
                <input type="text" class="form-control form_control" placeholder="用户名" name="username" id="input_username" title="请输入用户名"/>
                <input type="password" class="form-control form_control" placeholder="密码" name="password" id="input_password" title="请输入密码" autocomplete="on">
