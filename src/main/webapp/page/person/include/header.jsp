...
<head>
    ...
    <script src="${pageContext.request.contextPath}/page/person/res/js/jquery-1.11.3.min.js"></script>
    <script src="${pageContext.request.contextPath}/page/person/res/js/bootstrap.min.js"></script>
