...
<link rel="stylesheet" href="${pageContext.request.contextPath}/page/person/res/css/fore/fore_nav.css"/>
<%@ include file="/page/person/include/header.jsp" %>
<script src="${pageContext.request.contextPath}/page/person/res/js/jquery-color-2.1.2.js"></script>
    ...
    <div class="nav_main">
        ...
        <ul class="quick_li">
            ...
            <li class="quick_li_cart">
                <img id="img1"  src="${pageContext.request.contextPath}/page/person/res/images/fore/WebsiteImage/buyCar.png">
            ...
            <li class="quick_li_mobile">
                <img id="img1" src="${pageContext.request.contextPath}/page/person/res/images/fore/WebsiteImage/mobile.png">
                <a href="#" title="移动端">手机版</a>
                <div class="quick_qrcode">
                    <img src="${pageContext.request.contextPath}/page/person/res/images/fore/WebsiteImage/qrcode.png">
                    <b></b>
                </div>
            </li>
...
<%--&lt;%&ndash;搜索和logo&ndash;%&gt;--%>
<%--<div class="header">--%>
    <%--<img src="${pageContext.request.contextPath}/page/person/two/images/logobig.png">--%>
