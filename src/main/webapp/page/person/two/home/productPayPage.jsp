...
<body>
<nav>
    <%@ include file="/page/person/include/navigator.jsp" %>
    <div class="header">
        <div id="mallLogo">
...
<div class="content">
    ...
    <a href="${pageContext.request.contextPath}/order/pay/${requestScope.productOrder.productOrder_code}">aaaa${requestScope.productOrder.productOrder_code}</a>
