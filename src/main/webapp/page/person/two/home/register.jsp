...
<nav>
    <div class="header">
        <div id="mallLogo">
            <a href="${pageContext.request.contextPath}" onClick="javascript :history.back(-1);"><img
                    src="${pageContext.request.contextPath}/page/person/two/images/juheng.png"><span
