...
<title>付款成功页面</title>
<link rel="stylesheet"  type="text/css" href="${pageContext.request.contextPath}/page/person/two/AmazeUI-2.4.2/assets/css/amazeui.css"/>
...
<link href="${pageContext.request.contextPath}/page/person/two/css/sustyle.css" rel="stylesheet" type="text/css" />
