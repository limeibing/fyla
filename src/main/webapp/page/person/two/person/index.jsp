...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="${pageContext.request.contextPath}/page/person/two/css/vipstyle.css" rel="stylesheet" type="text/css">
						...
						<div class="m-user">
							...
							<div class="wallet">
								...
								<p class="m-big squareS">
									<a href="#">
										<i><img src="${pageContext.request.contextPath}/page/person/two/images/shopping.png"/></i>
										<span class="m-title">能购物</span>
									</a>
								</p>
								<p class="m-big squareA">
									<a href="#">
										<i><img src="${pageContext.request.contextPath}/page/person/two/images/safe.png"/></i>
										<span class="m-title">够安全</span>
									</a>
								</p>
								<p class="m-big squareL">
									<a href="#">
										<i><img src="${pageContext.request.contextPath}/page/person/two/images/profit.png"/></i>
						...
						<div class="m-order">
							...
							<div class="orderContentBox">
								<div class="orderContent">
									<div class="orderContentpic">
										<div class="imgBox">
											<a href="orderinfo.html"><img src="${pageContext.request.contextPath}/page/person/two//images/youzi.jpg"></a>
										</div>
									</div>
							...
							<div class="orderContentBox">
								<div class="orderContent">
									<div class="orderContentpic">
										<div class="imgBox">
											<a href="orderinfo.html"><img src="${pageContext.request.contextPath}/page/person/two/images/heart.jpg"></a>
										</div>
									</div>
									<div class="detailContent">
							...
							<div class="twoTabModel credit">
								...
								<div class="Box">
									...
									<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:108, itemMargin:3, slideshow: false}">
										<ul class="am-slides">
											<li><a href="#"><img src="${pageContext.request.contextPath}/page/person/two/images/333.jpg" /></a></li>
											<li><a href="#"><img src="${pageContext.request.contextPath}/page/person/two/images/222.jpg" /></a></li>
											<li><a href="#"><img src="${pageContext.request.contextPath}/page/person/two/images/111.jpg" /></a></li>
											<li><a href="#"><img src="${pageContext.request.contextPath}/page/person/two/images/333.jpg" /></a></li>
											<li><a href="#"><img src="${pageContext.request.contextPath}/page/person/two/images/222.jpg" /></a></li>
											<li><a href="#"><img src="${pageContext.request.contextPath}/page/person/two/images/111.jpg" /></a></li>
										</ul>
					...
					<div class="am-tabs-bd">
						...
						<div data-tab-panel-0 class="am-tab-panel am-active">
							<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:155,slideshow: false}">
								<ul class="am-slides">
									<li>
										<a><img class="am-thumbnail" src="${pageContext.request.contextPath}/page/person/two/images/EZA27501.jpg" /></a>
										<strong class="price">¥32.9</strong>
									</li>
									<li>
										<a><img class="am-thumbnail" src="${pageContext.request.contextPath}/page/person/two/images/BxJk6.jpg" /></a>
										<strong class="price">¥32.9</strong>
									</li>
									<li>
										<a><img class="am-thumbnail" src="${pageContext.request.contextPath}/page/person/two/images/Hxcag60.jpg" /></a>
										<strong class="price">¥32.9</strong>
									</li>
									<li>
										<a><img class="am-thumbnail" src="${pageContext.request.contextPath}/page/person/two/images/youzi.jpg" /></a>
										<strong class="price">¥32.9</strong>
									</li>
									<li>
										<a><img class="am-thumbnail" src="${pageContext.request.contextPath}/page/person/two/images/EZA27501.jpg" /></a>
