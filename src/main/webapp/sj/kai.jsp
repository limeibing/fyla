                    ...
                    <div data-reactroot=""><i class="open-icon " style="position: fixed; left: -9999px;"></i>
                        <div class="page-container">
                            <div class="first-title"><h1>我要开店</h1>
                                <p><!-- react-text: 7 -->一个身份只能开一家店; 开店后店铺无法注销; 申请到正式开通预计需1~3个工作日。了解更多请看<!-- /react-text --><a target="_blank"
                                ...
                                <div class="select-type-content">
                                    <div class="open-type-item">
                                        <div class="open-type-item-container">
                                            ...
                                            <p class="select-desc">通过支付宝个人实名认证的商家创建的店铺, 就是个人店铺。</p><a type="primary"
                                                                                                      href="/kai2"     class="next-btn next-btn-primary next-btn-large ice-link  select-type-item-btn">
                                            <!-- react-text: 41 -->创建个人店铺<!-- /react-text --></a>
                                    ...
                                    <div class="open-type-item">
                                        <div class="open-type-item-container">
                                            ...
                                            <p class="select-desc">通过支付宝企业认证的商家创建的店铺, 就是企业店铺。</p><a disabled="" type="primary" class="next-btn next-btn-primary next-btn-large ice-link  select-type-item-btn">
                                            <!-- react-text: 50 -->创建企业店铺<!-- /react-text --></a>
                                            <div class="select-tip"><span><!-- react-text: 53 -->请使用<!-- /react-text --><a
                                                    href="https://login.taobao.com/member/login.jhtml">企业账户</a><!-- react-text: 55 -->登陆开店
                                                <!-- /react-text --></span></div>
                                        </div>
                                    </div>
                                </div>
...
<iframe style="wid 0px; height: 0px; display: none;"
