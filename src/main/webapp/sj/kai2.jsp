                    ...
                    <div data-reactroot=""><i class="open-icon " style="position: fixed; left: -9999px;"></i>
                        <div class="page-container">
                            <div class="first-title"><h1>我要开店</h1>
                                <p><!-- react-text: 68 -->一个身份只能开一家店; 开店后店铺无法注销; 申请到正式开通预计需1~3个工作日。了解更多请看
                                    <!-- /react-text --><a target="_blank"
                            ...
                            <div class="open-step">
                                <div class="next-step next-step-arrow next-step-horizontal steps-container">
                                    <div class="next-step-item next-step-item-finish next-step-item-first"
                                         style="width: auto;">
                            ...
                            <div class="open-page read-agreement">
                                <div class="read-agreement-content">
                                    <div class="read-agreement-paper">
                                        ...
                                        <p class="answer">
                                            答：不可以。未经淘宝平台同意，将本人淘宝账号提供给他人作开店使用，否则由此导致相关争议、诉讼及因店铺经营中的违法违规行为导致一切人身、财产权益损害，均由本人自行承担全部民事、行政及刑事责任。</p>
                                        ...
                                        <p class="answer">
                                            答：不可以。一张身份证（一张营业执照）只能开一个淘宝店铺。开店后请保持营业执照存续状态，不得注销；如若发现营业执照被注销、吊销，淘宝将会对店铺做出永久关闭的处置。</p>

                                        <p class="question">4、我已经开过淘宝店，现在想要注销原来的店铺重新开店，可以吗?</p>
                                        <p class="answer">答：不可以，淘宝暂时不提供注销店铺的服务。用户一但成功开店就无法再用身份证（营业执照）另开一家淘宝店铺。</p>
                                    </div>
                                    <div class="read-agreement-tip"><i
                                            class="next-icon next-icon-prompt next-icon-medium"></i>
                                        <p>1、淘宝网在任何情况下都不会用QQ与您取得联系, 任何使用QQ联系您的"工作人员"都是骗子。</p>
                                        <p><!-- react-text: 100 -->2、消费者保障协议变更内容将于2017年12月01日零点生效，主要变更点可见协议公示通知（
                                            <!-- /react-text --><a
                                                    href="https://hot.bbs.taobao.com/detail.html?postId=8115168"
                                                    target="_blank">https://hot.bbs.taobao.com/detail.html?postId=8115168</a>
                                            <!-- react-text: 102 -->）。相关重要条款我们已以粗体下划线的方式特别标注，请重点阅读。<!-- /react-text -->
                                        </p></div>
                                    <div class="read-agreement-actions"><a href="/kai"
                                            class="next-btn next-btn-normal next-btn-large ice-link  " type="normal">
                                        <!-- react-text: 105 -->上一步<!-- /react-text --></a><a type="primary" href="/kai4"
                                                                                              class="next-btn next-btn-primary next-btn-large ice-link  ">
                                        <!-- react-text: 107 -->我已了解, 继续开店<!-- /react-text --></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
